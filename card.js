...
function handleSubmit(e) {
    ...
    if (!numberInp.value) {
      ...
      numberInp.parentElement.classList.add("error_message");
        ...
        numberInp.classList.add("error")
        numberInp.parentElement.classList.add("number_error");
    } else {
    ...
    if (!monthInp.value) {
      ...
      monthInp.classList.add("error")
      monthInp.parentElement.classList.add("month_error");
    } else {
      monthInp.classList.remove("error");
      monthInp.parentElement.classList.remove("error_message");
      monthInp.parentElement.classList.remove("month_error");
    }
    if (!yearInp.value) {
    ...
    if (!cvcInp.value) {
      ...
      cvcInp.classList.add("error")
      cvcInp.parentElement.classList.add("number_error");
    } else {
    ...
    //   setCardNumber(numberInp)
    //   setCardName(nameInp)
    //   setCardMonth(monthInp)
    //   setCardYear(yearInp)
    //   setCardCvc(cvcInp)
